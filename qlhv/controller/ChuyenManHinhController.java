...
import qlhv.view.DocGiaJPanel;
import qlhv.view.MuonSachJPanel;
import qlhv.view.SachJPanel;
...
public class ChuyenManHinhController {
    ...
    public void setView(JPanel jpnItem, JLabel jlbItem) {
        ...
        jpnItem.setBackground(new Color(191, 191, 191));
        jlbItem.setBackground(new Color(191, 191, 191));
        ...
        public void mouseClicked(MouseEvent e) {
            switch (kind) {
                ...
                case "Sach":
                    ...
                    break;
                case "DocGia":
                    node = new DocGiaJPanel();
                    break;
                default:
                    node = new MuonSachJPanel();
                    break;
            }
            root.removeAll();
            root.setLayout(new BorderLayout());
